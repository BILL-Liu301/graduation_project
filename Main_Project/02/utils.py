...
training_data_input = np.zeros((training_data_reshaped.shape[0],
                                training_data_reshaped.shape[1] - 3))
training_data_output = np.zeros((training_data_reshaped.shape[0], 3))
for i in range(len(training_data_input)):
    ...
    training_data_output[i, 0:len(training_data_output[i])] = training_data_reshaped[i, 7:len(training_data_reshaped[i])]
...
testing_data_input = np.zeros((testing_data_reshaped.shape[0],
                               testing_data_reshaped.shape[1] - 3))
testing_data_output = np.zeros((testing_data_reshaped.shape[0], 3))
for i in range(len(testing_data_input)):
    ...
    testing_data_output[i, 0:len(testing_data_output[i])] = testing_data_reshaped[i, 7:len(testing_data_reshaped[i])]
